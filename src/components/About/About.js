        ...
        <section id="about" className="about">
            ...
            <div className="side">
                ...
                <p>
                    ...
                    <br /><br />
                    Alongside my academic coursework in AI, computer systems, architecture, and algorithm design, I pursue personal and team-based projects that explore the intersection of intelligence and software. I am currently seeking research and internship opportunities in AI, systems, and full-stack development.
                </p>
            </div>
        </section>
    )
